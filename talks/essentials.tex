...
\item adapt (and break up) simple installation script \todo and tarballs from \code{saxs/}
...
\end{itemize}
\item Ensure SSH keys are installed to copy files between head and worker nodes
\begin{itemize}
\item \todo
\end{itemize}
